...
import profilePic from "@/app/pp.jpg";

export default function Footer() {
  return (
    <footer className="z-0 relative bottom-4 left-1/2 transform -translate-x-1/2 w-[70%] bg-orange-800/90 backdrop-blur-md p-4 rounded-lg shadow-lg border border-orange-500/50 hover:border-orange-500 transition-all">
      <div className="flex justify-between items-center">
        ...
        <div className="relative w-10 h-10 rounded-full overflow-hidden">
          ...
          <p className="text-gray-300">Developed by Kentuckyfb</p>
        </div>
        <div className="flex items-center space-x-4">
          <a
